...
## Project Structure
    ...
    ├── customer_relation_s_33244  # Django project configurations
...
1. Clone this repo and `cd customer_relation_s_33244`
...
2. Clone this repo and `cd customer_relation_s_33244`
